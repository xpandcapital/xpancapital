...
INSERT INTO formas_pago (nombre, slug, descripcion, activo, config, orden) VALUES
  ...
  ('Transferencia Bancaria', 'transfer', 'Pago por transferencia bancaria', true, '{"provider": "manual", "whatsapp": "+51999999999", "instructions": "Envía el comprobante de pago por WhatsApp para validar tu compra.", "countries": {"peru": {"label": "Perú", "flag": "🇵🇪", "currency": "PEN", "banks": [{"name": "Banco de Crédito BCP", "account_number": "123-456-789", "account_holder": "BLIS Corp SAC", "cci": "00212300456789012345", "account_type": "ahorros"}, {"name": "Interbank", "account_number": "987-654-321", "account_holder": "BLIS Corp SAC", "cci": "00398700654321098765", "account_type": "corriente"}]}}}', 4),
