...
export function CorreoLayout({ sidebarOpen, onToggleSidebar }: { sidebarOpen: boolean; onToggleSidebar: (v: boolean) => void }) {
  ...
  return (
    <div className="w-full max-w-[calc(100vw-2rem)] md:max-w-full h-full min-h-[400px] bg-zinc-950/50 md:rounded-3xl md:border md:border-white/5 overflow-hidden flex flex-col">
      {/* ===== DESKTOP LAYOUT (md+) ===== */}
