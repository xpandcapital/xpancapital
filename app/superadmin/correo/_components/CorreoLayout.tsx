...
export function CorreoLayout({ sidebarOpen, onToggleSidebar }: { sidebarOpen: boolean; onToggleSidebar: (v: boolean) => void }) {
  ...
  return (
    <div className="w-full max-w-[calc(100vw-4rem)] md:max-w-full mx-auto md:mx-0 flex-1 min-h-0 md:bg-zinc-950/50 md:rounded-3xl md:border md:border-white/5 overflow-hidden flex flex-col">
      {/* ===== DESKTOP LAYOUT (md+) ===== */}
