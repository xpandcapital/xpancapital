...
export const categories: ApiCategory[] = [
    ...
    },
    {
        ...
        apps: [
            ...
            { id: "finnhub", name: "Finnhub", icon: TrendingUp, color: "text-green-400", bg: "bg-green-500/10", description: "Noticias financieras en tiempo real, calendario económico, datos de mercado y análisis de sentimiento. Ideal para portales de trading.", website: "finnhub.io", fields: [{ id: "finnhub_api_key", label: "API Key", type: "password", description: "Clave para Finnhub API. Noticias de mercado, calendario económico, cotizaciones.", getFrom: "finnhub.io → Dashboard → API Key", accessType: "Privada", cost: "freemium" }] },
            { id: "jbnews", name: "JBlanked Forex News", icon: TrendingUp, color: "text-cyan-400", bg: "bg-cyan-500/10", description: "API de noticias forex con sentimiento IA. Eventos en tiempo real, backtesting, predicciones ML, análisis GPT. Outcome + Strength + Quality por evento.", website: "jblanked.com", fields: [{ id: "jbnews_api_key", label: "API Key", type: "password", description: "Clave para JBlanked News API. Accede a eventos forex con IA.", getFrom: "jblanked.com → Profile → API Key", accessType: "Privada", cost: "freemium" }] },
        ]
    },
    {
        id: "comunicaciones",
