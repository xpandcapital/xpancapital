        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
          <div className="bg-zinc-900 border border-white/10 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 space-y-4">
            ...
            <div>
              ...
              <input value={waForm.nombre} onChange={e => setWaForm(p => ({...p, nombre: e.target.value}))} className="w-full" placeholder="Remarketing Julio 2026" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input type="number" value={waForm.min_delay_seconds} onChange={e => setWaForm(p => ({...p, min_delay_seconds: parseInt(e.target.value)||30}))} className="w-full" />
              </div>
              <div>
                <label className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Delay máximo (seg)</label>
                <input type="number" value={waForm.max_delay_seconds} onChange={e => setWaForm(p => ({...p, max_delay_seconds: parseInt(e.target.value)||120}))} className="w-full" />
              </div>
            </div>
            ...
            <div>
              ...
              <input value={waForm.media_url} onChange={e => setWaForm(p => ({...p, media_url: e.target.value}))} className="w-full" placeholder="https://..." />
            </div>
