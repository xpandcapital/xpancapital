    ...
    return (
        <div className="space-y-8 w-full mx-auto pb-32 px-4 md:px-8 pt-8 md:pt-8 bg-black min-h-screen">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 sm:gap-0">
                ...
                <button 
                    onClick={handleSave}
                    className="w-full sm:w-auto bg-blis-red text-white px-8 py-4 sm:py-5 rounded-3xl font-black uppercase tracking-widest text-xs hover:scale-105 active:scale-95 transition-all flex items-center justify-center shrink-0 gap-2 shadow-[0_10px_20px_rgba(213,193,8,0.3)] mt-4 sm:mt-0"
                >
