...
export const INITIAL_BLOCKS = [
  { id: getUniqueId('header'), type: 'header', content: { ...getDefaultContent('header', activePal), logoUrl: 'https://cloud.xpandcapital.org/d/ucnxd3PrBf1kMBJNb7sE09KUO8Nh6Y/MTMxfHBhZGRpbg.png', bgColor: '#181818', padding: 0, logoWidth: 600, align: 'center' } },
  ...
  { id: getUniqueId('button'), type: 'button', content: { ...getDefaultContent('button', activePal), text: 'Visita Nuestra Web', url: 'https://xpandcapital.org/', borderRadius: 8, paddingY: 15, paddingX: 40, align: 'center' } },
  ...
  { id: getUniqueId('columns'), type: 'columns', content: { colCount: 2, bgColor: 'transparent', padding: 0, align: 'top', cols: [
    [ { id: getUniqueId('image'), type: 'image', content: { ...getDefaultContent('image', activePal), imageUrl: 'https://cloud.xpandcapital.org/d/U8IMTGWOIWDocWpLEV8UBqILeC1rd4/MTIxfHBhZGRpbg.jpg', width: 100, borderRadius: 8, padding: 0 } }, { id: getUniqueId('text'), type: 'text', content: { ...getDefaultContent('text', activePal), text: 'Academia XpandCapital', fontSize: 18, fontWeight: 'bold', padding: 0, align: 'left' } }, { id: getUniqueId('text'), type: 'text', content: { ...getDefaultContent('text', activePal), text: 'Accede a nuestros cursos y plataforma de aprendizaje integral.', fontSize: 14, padding: 0, align: 'left', textColor: '#6b7280' } }, { id: getUniqueId('button'), type: 'button', content: { ...getDefaultContent('button', activePal), text: 'Campus Virtual', url: 'https://campus.xpandcapital.org/', width: 'full', padding: 0, borderRadius: 6 } } ],
    [ { id: getUniqueId('image'), type: 'image', content: { ...getDefaultContent('image', activePal), imageUrl: 'https://cloud.xpandcapital.org/d/EfP8HeSuCuPi4gXCGMC70uhWknu7XB/MTIzfHBhZGRpbg.png', width: 100, borderRadius: 8, padding: 0 } }, { id: getUniqueId('text'), type: 'text', content: { ...getDefaultContent('text', activePal), text: 'Kevin Valdez', fontSize: 18, fontWeight: 'bold', padding: 0, align: 'right' } }, { id: getUniqueId('text'), type: 'text', content: { ...getDefaultContent('text', activePal), text: 'Master Admin. Gestión de proyectos y utilidades CRM.', fontSize: 14, padding: 0, align: 'right', textColor: '#6b7280' } }, { id: getUniqueId('button'), type: 'button', content: { ...getDefaultContent('button', activePal), text: 'Revista Oficial', url: 'https://revista.xpandcapital.org/', width: 'full', padding: 0, buttonBgColor: '#181818', borderRadius: 6 } } ]
  ] } },
  ...
  { id: getUniqueId('image'), type: 'image', content: { ...getDefaultContent('image', activePal), imageUrl: 'https://cloud.xpandcapital.org/d/cIVlsARe6fHQu1wRMInI2YkUwjV2Va/MTMwfHBhZGRpbg.png', width: 40, borderRadius: 0, padding: 0, align: 'center' } }
];
