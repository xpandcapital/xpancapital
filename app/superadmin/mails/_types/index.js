...
export const getDefaultContent = (type, activePalette = DEFAULT_PALETTES[1]) => {
  switch (type) {
    ...
    case 'social': return { align: 'center', bgColor: 'transparent', bgImageUrl: '', bgSize: 'cover', bgPosition: 'center', padding: 20, iconSize: 24, borderRadius: 8, networks: [ { id: getUniqueId('net'), network: 'facebook', url: 'https://facebook.com/bliscorp', iconColor: '#ffffff', bgColor: '#1877F2' }, { id: getUniqueId('net'), network: 'instagram', url: 'https://instagram.com/bliscorp', iconColor: '#ffffff', bgColor: '#E1306C' }, { id: getUniqueId('net'), network: 'linkedin', url: 'https://linkedin.com/company/bliscorp', iconColor: '#ffffff', bgColor: '#0077B5' }, { id: getUniqueId('net'), network: 'youtube', url: 'https://youtube.com/@bliscorp', iconColor: '#ffffff', bgColor: '#FF0000' }, { id: getUniqueId('net'), network: 'whatsapp', url: 'https://wa.me/51999999999', iconColor: '#ffffff', bgColor: '#25D366' }, { id: getUniqueId('net'), network: 'tiktok', url: 'https://tiktok.com/@bliscorp', iconColor: '#ffffff', bgColor: '#000000' } ] };
    ...
    case 'receipt': return { bgColor: '#111111', accentColor: '#4ade80', headerBg: '#1a1a1a', rowBg1: '#141414', rowBg2: '#111111', totalBg: '#0a1a0f', padding: '24px', showDiscount: true, items: [ { nombre: '{{producto_1_nombre}}', categoria: '{{producto_1_categoria}}', precio: '{{producto_1_precio}}', imagen: '{{producto_1_imagen}}' }, { nombre: '{{producto_2_nombre}}', categoria: '{{producto_2_categoria}}', precio: '{{producto_2_precio}}', imagen: '{{producto_2_imagen}}' }, { nombre: '{{producto_3_nombre}}', categoria: '{{producto_3_categoria}}', precio: '{{producto_3_precio}}', imagen: '{{producto_3_imagen}}' }, ], subtotalVar: '{{subtotal}}', descuentoVar: '{{descuento_monto}}', cuponVar: '{{cupon}}', totalVar: '{{total}}', metodoPagoVar: '{{metodo_pago}}', fechaVar: '{{fecha}}' };
...
export const INITIAL_BLOCKS = [
  ...
  { id: getUniqueId('columns'), type: 'columns', content: { colCount: 2, bgColor: 'transparent', padding: 20, align: 'top', cols: [
    [ { id: getUniqueId('image'), type: 'image', content: { ...getDefaultContent('image', activePal), imageUrl: 'https://cloud.blis-corp.com/d/U8IMTGWOIWDocWpLEV8UBqILeC1rd4/MTIxfHBhZGRpbg.jpg', width: 100, borderRadius: 8, padding: 5 } }, { id: getUniqueId('text'), type: 'text', content: { ...getDefaultContent('text', activePal), text: 'Academia BlisCorp', fontSize: 18, fontWeight: 'bold', padding: 5, align: 'left' } }, { id: getUniqueId('text'), type: 'text', content: { ...getDefaultContent('text', activePal), text: 'Accede a nuestros cursos y plataforma de aprendizaje integral.', fontSize: 14, padding: 5, align: 'left', textColor: '#6b7280' } }, { id: getUniqueId('button'), type: 'button', content: { ...getDefaultContent('button', activePal), text: 'Campus Virtual', url: 'https://campus.blis-corp.com/', width: 'full', padding: 5, borderRadius: 6 } } ],
    [ { id: getUniqueId('image'), type: 'image', content: { ...getDefaultContent('image', activePal), imageUrl: 'https://cloud.blis-corp.com/d/EfP8HeSuCuPi4gXCGMC70uhWknu7XB/MTIzfHBhZGRpbg.png', width: 100, borderRadius: 8, padding: 5 } }, { id: getUniqueId('text'), type: 'text', content: { ...getDefaultContent('text', activePal), text: 'Kevin Valdez', fontSize: 18, fontWeight: 'bold', padding: 5, align: 'right' } }, { id: getUniqueId('text'), type: 'text', content: { ...getDefaultContent('text', activePal), text: 'Master Admin. Gestión de proyectos y utilidades CRM.', fontSize: 14, padding: 5, align: 'right', textColor: '#6b7280' } }, { id: getUniqueId('button'), type: 'button', content: { ...getDefaultContent('button', activePal), text: 'Revista Oficial', url: 'https://revista.blis-corp.com/', width: 'full', padding: 5, buttonBgColor: '#181818', borderRadius: 6 } } ]
  ] } },
