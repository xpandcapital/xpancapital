...
import { LayoutGrid, List, FileSpreadsheet, Download, RefreshCw, Settings } from 'lucide-react';
import Link from 'next/link';

export default function DashboardPage() {
  const { activeProjectId, slug } = useProject();
  const { isSyncing, sortedLots, sortedDesistidoLots, desistidoLots, dashboardStats } = useLotes(activeProjectId || '');
