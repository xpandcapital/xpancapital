...
import { Store, DollarSign, Coins, Tag, ImageIcon, ChevronDown, ChevronUp } from "lucide-react"
...
export function TiendaSection({ course, onUpdate }: Props) {
  ...
  const toggle = (v: boolean) => {
    setExpanded(v)
    onUpdate({ ...course, venderEnTienda: v })
  }
          ...
          <div className="text-left">
            ...
            <p className="text-[11px] text-gray-500">
              {course.venderEnTienda
                ? 'Este curso está publicado como producto'
