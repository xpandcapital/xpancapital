...
export default function AdminLayout({
    ...
    return (
        <div className="flex bg-black h-[calc(100vh-80px)] overflow-hidden relative">
            <SuperadminSidebar />
            <div className="flex-1 flex flex-col relative z-50 min-w-0 min-h-0 pl-[56px] md:pl-0 pt-24 transition-[padding] duration-300">
                ...
                <main className="flex-1 min-h-0 p-0 md:p-0 z-50 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-white/10 w-full max-w-full bg-black">
