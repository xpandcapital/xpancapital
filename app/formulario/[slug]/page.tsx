...
export default function FormularioPage({ params }: { params: Promise<{ slug: string }> }) {
      ...
      <main className="bg-black min-h-screen text-white">
        ...
        <div className="flex items-center justify-center min-h-[80vh]">
          <div className="text-center">
            <h1 className="text-4xl font-black mb-4">Formulario no encontrado</h1>
            <p className="text-gray-400 mb-8">El formulario que buscas no existe o ha sido eliminado.</p>
            <a 
              href="/" 
