  ...
  articles: [
    {
      ...
      icon: "check",
      content: `<p>Al acceder y utilizar el sitio web <strong>blis-corp.com</strong> (en adelante, "la Plataforma"), usted acepta estar sujeto a estos Términos y Condiciones. Si no está de acuerdo con alguna parte de estos términos, no debe utilizar la Plataforma.</p>
<p>BLIS CORP S.A.C. se reserva el derecho de modificar estos términos en cualquier momento. Los cambios entrarán en vigor inmediatamente después de su publicación. El uso continuado de la Plataforma constituye la aceptación de dichas modificaciones.</p>`,
    },
    {
      title: "2. Descripción del Servicio — Contenido Educativo Digital",
      icon: "book",
      content: `<p><strong>BLIS CORP S.A.C.</strong>, a través de su plataforma digital blis-corp.com, se dedica <strong>exclusivamente a la comercialización de contenido educativo digital</strong>, incluyendo pero no limitado a:</p>
<ul>
...
<p>Debe proporcionar información precisa, actualizada y completa durante el proceso de registro. BLIS CORP S.A.C. se reserva el derecho de suspender o cancelar cuentas que proporcionen información falsa o incompleta.</p>`,
    },
    {
      title: "4. Compras y Pagos",
      icon: "file",
      content: `<p>Los pagos realizados en la Plataforma se procesan a través de pasarelas de pago de terceros. BLIS CORP S.A.C. no almacena datos de tarjetas de crédito o débito.</p>
...
<p>Al realizar una compra, usted acepta que el procesador de pago pueda verificar su información y autorizar la transacción. BLIS CORP S.A.C. no es responsable de demoras o rechazos por parte del procesador de pago.</p>`,
    },
    {
...
<p>Al adquirir un producto digital, se le otorga una <strong>licencia de uso personal, no exclusiva e intransferible</strong>. Está prohibida la redistribución, reventa, modificación o creación de obras derivadas sin autorización expresa por escrito de BLIS CORP S.A.C.</p>
<p>El acceso a los cursos y membresías es personal e intransferible. Compartir credenciales de acceso constituye una violación de estos términos y puede resultar en la cancelación de su cuenta.</p>`,
    },
    {
      ...
      icon: "shield",
      content: `<p>Todo el contenido de la Plataforma, incluyendo textos, gráficos, logotipos, imágenes, videos, software, y la disposición de los mismos, es propiedad exclusiva de BLIS CORP S.A.C. o de sus licenciantes y está protegido por las leyes de propiedad intelectual de Perú y tratados internacionales.</p>
<p>Las marcas "BLIS Corp", el logotipo y cualquier otra marca registrada son propiedad de BLIS CORP S.A.C.</p>`,
    },
    {
      title: "7. Limitación de Responsabilidad",
      icon: "alert",
      content: `<p>BLIS CORP S.A.C. no será responsable por daños directos, indirectos, incidentales, especiales o consecuentes que resulten del uso o la imposibilidad de usar la Plataforma o los productos adquiridos.</p>
...
<ul>
  <li><strong>Email:</strong> legal@blis-corp.com</li>
