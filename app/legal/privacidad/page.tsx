  ...
  articles: [
    {
      ...
      icon: "file",
      content: `<p><strong>BLIS CORP S.A.C.</strong>, con domicilio en la ciudad de Arequipa, Perú, es el responsable del tratamiento de sus datos personales. Puede contactar a nuestro Delegado de Protección de Datos en: <strong>privacidad@blis-corp.com</strong></p>`,
    },
    {
...
<p>Para ejercer estos derechos, envíe un email a <strong>privacidad@blis-corp.com</strong>. Responderemos en un plazo máximo de 20 días hábiles.</p>`,
    },
    {
