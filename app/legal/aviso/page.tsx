...
const data: LegalPageData = {
  hero: {
    title: "Aviso Legal",
    subtitle: "Información legal y corporativa de XPAND CORP S.A.C.",
...
<ul>
  <li><strong>Denominación Social:</strong> XPAND CORP S.A.C.</li>
  ...
  <li><strong>Email de Contacto:</strong> legal@xpandcapital.org</li>
    ...
    },
    {
      ...
      icon: "book",
      content: `<p>XPAND CORP S.A.C. tiene por objeto social, entre otras actividades:</p>
<ul>
...
<p>Cualquier intento de utilizar la Plataforma para realizar transacciones inmobiliarias sin la debida autorización será considerado una violación de estos términos y podrá resultar en la cancelación inmediata de la cuenta y la notificación a las autoridades competentes.</p>`,
    },
    {
      ...
      icon: "shield",
      content: `<p>XPAND CORP S.A.C. mantiene operaciones comerciales en la República del Perú y la República del Ecuador. Las transacciones realizadas en cada país se rigen por la legislación local aplicable.</p>
<p>Para operaciones en Ecuador, la empresa cumple con las disposiciones de la Superintendencia de Compañías, Valores y Seguros, y demás normativa ecuatoriana pertinente.</p>`,
    },
    {
      ...
      icon: "shield",
      content: `<p>Todos los elementos que componen este sitio web (marcas, logotipos, textos, imágenes, videos, software, base de datos, código fuente, diseño gráfico) son propiedad exclusiva de XPAND CORP S.A.C. o de terceros que han autorizado su uso, y están protegidos por las leyes de propiedad intelectual e industrial.</p>
<p>Queda prohibida la reproducción total o parcial, distribución, comunicación pública o transformación de cualquier elemento de este sitio web sin la autorización expresa y por escrito de XPAND CORP S.A.C.</p>`,
    },
    {
      title: "6. Exclusión de Responsabilidad",
      content: `<p>XPAND CORP S.A.C. no se hace responsable de los daños y perjuicios que pudieran derivarse de:</p>
<ul>
