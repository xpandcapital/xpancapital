                ...
                <div className="space-y-5 animate-fadeIn">
                  ...
                  {campaignConfig.type === 'grupos' && (
                    <div className="bg-gray-50 dark:bg-[#161616] p-4 rounded-xl border border-gray-200 dark:border-[#333] text-center py-8">
                      ...
                      <h4 className="text-sm font-bold text-gray-700 dark:text-gray-300">Envío Masivo a Grupos</h4>
                      <p className="text-xs text-gray-500 mt-1 max-w-sm mx-auto">Selecciona grupos o segmentos (ej: "Clientes VIP", "Leads Octubre"). Requiere módulo de segmentación activo.</p>
                      <select className="mt-4 w-full max-w-xs px-3 py-2 border border-gray-300 dark:border-[#444] rounded-lg bg-white dark:bg-[#0a0a0a] text-sm mx-auto block">
                        ...
                        <option value="asesores">Equipo de Ventas</option>
              ...
              {sendTab === 'smtp' && (
                <div className="space-y-4 animate-fadeIn">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-bold text-gray-600 dark:text-gray-400 mb-1">Nombre Remitente</label>
                      <input type="text" placeholder="Ej: Ventas BLIS Corp" value={campaignConfig.fromName} onChange={(e) => setCampaignConfig({...campaignConfig, from
