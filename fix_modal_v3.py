...
modal_code = """{isCheckoutOpen && (
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        {/* RIGHT COLUMN: Payment Input & Totals */}
                        {!invoiceResult && (
...
final_content = prefix + modal_code + suffix

with open(filepath, 'w', encoding='utf-8', newline='\\n') as f:
    f.write(final_content)

print("Modal completely refactored and fixed")
"""

with open('fix_modal_v3.py', 'w', encoding='utf-8') as f:
    f.write(modal_fixing_script)
"""
