...
import { MapPin, Navigation, Eye, Building, Home, Layers } from "lucide-react";
                                ...
                                {locations.map((loc, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 flex items-center justify-between">
                                            <div>
                                                <span className="text-white font-bold text-sm uppercase tracking-wider transition-colors" style={{ textShadow: `0 0 15px ${loc.dotColor}00` }}>{loc.name}</span>
                        ...
                        >
                            ...
                            {locations.map((loc, idx) => (
                                ...
                                >
                                    ...
                                    <div className="w-4 h-4 rounded-full relative z-10 border-2 border-black"
                                        style={{ backgroundColor: loc.dotColor, boxShadow: `0 0 15px ${loc.dotColor}` }} />
                            ...
                            <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end pointer-events-none">
                                ...
                                <div className="flex gap-2">
                                    {/* Dinámicamente podríamos extraer provincias únicas, pero por ahora lo dejamos estático o lo simplificamos */}
