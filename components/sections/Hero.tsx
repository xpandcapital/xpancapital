    ...
    <motion.div
            ...
            >
                ...
                >
                    ...
                    <h1 className="text-6xl sm:text-7xl md:text-7xl lg:text-8xl xl:text-[8.5rem] 2xl:text-[10rem] font-black tracking-tighter text-white mb-3 sm:mb-4 md:mb-5 uppercase flex flex-row flex-wrap justify-center items-center gap-2 sm:gap-3 md:gap-4 xl:gap-6 leading-none cyber-flicker">
