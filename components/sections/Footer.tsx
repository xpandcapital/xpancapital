...
import { Facebook, Instagram, Linkedin, Twitter, Youtube, MessageCircle, Mail, Phone, MapPin, PlayCircle } from "lucide-react";
...
export function FooterSections() {
    ...
    const globalLinks = [
        ...
        { icon: Youtube, url: socials.tiktok, name: "TikTok" },
