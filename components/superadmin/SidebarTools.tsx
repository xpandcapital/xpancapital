...
{links.length > 0 && (
                <div className="space-y-2">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            {completedCount > 0 && (
                                <button onClick={clearCompleted} className="px-2.5 py-1 bg-white/5 hover:bg-white/10 rounded-lg text-[10px] text-gray-400 font-bold uppercase tracking-widest transition-all">Limpiar</button>
                            )}
                                ...
                                <div className="flex items-center gap-2 mt-0.5">
                                    ...
                                    {item.status === 'downloading' && (
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span className="text-[10px] text-amber-400 font-bold">Obteniendo enlaces...</span>
                                        </div>
                                    )}
                                    {item.status === 'done' && (
                                        <div className="flex flex-col gap-1">
                                            ...
                                            {item.downloadLinks && item.downloadLinks.length > 0 ? (
                                                <div className="flex flex-wrap gap-1 mt-0.5">
                                                    {item.downloadLinks.map((link: any) => (
                                                        <a key={link.quality} href={link.url} target="_blank" rel="noopener noreferrer"
                                                ...
                                                <a href={item.downloadUrl} target="_blank" rel="noopener noreferrer"
                                                    ...
                                                    <ExternalLink className="w-3 h-3" /> Abrir descarga
                                                </a>
                                            ) : null}
                                        </div>
                                    )}
