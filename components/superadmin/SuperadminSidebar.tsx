    ...
    return (
        <>
            <motion.aside
                ...
                className="flex flex-col bg-zinc-950 border-r border-white/5 h-screen fixed left-0 top-0 z-[999] overflow-hidden shadow-[15px_0_40px_rgba(0,0,0,0.8)] flex-shrink-0"
