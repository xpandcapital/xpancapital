...
const TOP_PRODUCTS = [
  {
    ...
    sales: 2847,
    rating: 4.9,
    image: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=300&q=80",
    trend: +24,
    badge: "Campeón",
  ...
  {
    rank: 4,
    title: "Ebook: Técnicas de Cierre Inmobiliario",
    category: "Ebooks",
    price: 29,
    originalPrice: 45,
    sales: 980,
    rating: 4.8,
    image: "https://images.unsplash.com/photo-1542382257-80dedb725088?w=300&q=80",
    trend: +8,
    badge: "Nuevo Hit",
