...
export function MiembrosSidebar() {
    ...
    const menuGroups = [
        {
            ...
            items: [
                ...
                { icon: ShoppingBag, label: "Mis Compras", href: "/miembros/productos" },
                { icon: Video, label: "Academia Blis", href: "/miembros/academia" },
    ...
    return (
        <motion.aside
            ...
            className="flex flex-col bg-black border-r border-white/5 h-[calc(100vh-80px)] fixed left-0 top-[80px] z-50 overflow-hidden shadow-[10px_0_30px_rgba(0,0,0,0.5)]"
        >
