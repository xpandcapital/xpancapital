...
# Using regex to find the start of the checkout block
# It looks like: { [newlines] isCheckoutOpen && (
start_pattern = r'\{\s*isCheckoutOpen\s*&&\s*\('
match = re.search(start_pattern, fc)
...
print("Modal refactored successfully with regex")
